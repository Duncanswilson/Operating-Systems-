...
But I'm a depressive realist and assume you will grade harshly so I've included a copy of my floating point timer in order for you to test my slightly off times against perfect results.

*Note: the code for correct_times_no_clock.c is not commented and should only be used for checking my clock using program's times*
 
This can be run by uncommenting the commented out line in the make file, commenting out the uncommented line and then re-running make

Thanks for reading all of this and for grading my program!   

PS: Reading code in SublimeText is much better than gedit :)  
